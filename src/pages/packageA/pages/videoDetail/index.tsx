      ...
      >
        ...
        {type === 'video' ? (
          <View className='videoDetail__play__container'>
            ...
            <View className='flex videoDetail__play__numinfo'>
              <View className='flex-item'>
                <Icon
                  ...
                  color='#323232'
                ></Icon>
                <View className='videoDetail__play__numinfo__text'>
                  {videoInfo.praisedCount}
                </View>
              </View>
              <View className='flex-item'>
                <Icon name='star' size='24' color='#323232'></Icon>
                <View className='videoDetail__play__numinfo__text'>
                  {videoInfo.subscribeCount}
                </View>
              </View>
              <View className='flex-item'>
                <Icon name='message' size='24' color='#323232'></Icon>
                <View className='videoDetail__play__numinfo__text'>
                  {videoInfo.commentCount}
                </View>
              </View>
              <View className='flex-item'>
                <Icon name='share' size='24' color='#323232'></Icon>
                <View className='videoDetail__play__numinfo__text'>
            ...
            <View className='videoDetail__play__user'>
              <Image
                ...
                className='videoDetail__play__user__cover'
              />
          ...
          <View className='videoDetail__play__container'>
            ...
            <View className='videoDetail__play__desc'>
              <Text className='videoDetail__play__playtime'>
                {formatCount(mvInfo.playCount)}次观看
              </Text>
            </View>
            {showMoreInfo ? (
        ...
        <View className='videoDetail_relation'>
          <View className='videoDetail__title'>相关推荐</View>
          {type === 'video' ? (
            <View>
        ...
        <View className='videoDetail__comment'>
          <View className='videoDetail__title'>精彩评论</View>
          <View className='videoDetail__comment__info'>
            {commentInfo.commentList.map((item) => (
              <View
                key={item.commentId}
                className='videoDetail__comment__info__item'
              >
                <View className='flex flex-between'>
                  <View className='flex flex-align-center'>
                    <Image
                      src={item.user.avatarUrl}
                      className='videoDetail__comment__info__item__avatar'
                    />
                    <View className='flex-item'>
                      <View className='videoDetail__comment__info__item__nickname'>
                        {item.user.nickname}
                      </View>
                      <View className='videoDetail__comment__info__item__time'>
                ...
                <View className='videoDetail__comment__info__item__content'>
                  {item.content}
                </View>
              </View>
            ))}
